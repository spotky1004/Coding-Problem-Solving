/**
 * @typedef {"Int32" | "BigInt64" | "any"} SegmentTreeElementTypes 
 */
/**
 * @interface 
 * @template Custom 
 * @typedef SegmentTreeElementType 
 * @property {number} Int32 
 * @property {BigInt} BigInt64 
 * @property {Custom | Default} any 
/**
 * @interface 
 * @template Custom 
 * @typedef SegmentTreeType
 * @property {Int32Array} Int32 
 * @property {BigInt} BigInt64 
 * @property {Custom | Default} any 
*/
/**
 * @template {SegmentTreeElementTypes} T 
 * @template {any} U 
 */
class SegmentTree {
  /**
   * @typedef {SegmentTreeElementType<U>[T]} ElementType 
   * @typedef {SegmentTreeType<U>[T]} TreeType 
   ...
   */
  constructor(type, values, defaultValue, mergeFunc, queryFuncs) {
    ...
    if (type === "Int32") {
      this.defaultValue = defaultValue ?? -2147483648;
      this.tree = new Int32Array(1 << this.height).fill(this.defaultValue);
    } else if (type === "BigInt64") {
      this.defaultValue = defaultValue ?? -9223372036854775808n;
      this.tree = new BigInt64Array(1 << this.height).fill(this.defaultValue);
    } else {
