...
// output
return isFinite(dijkstra(N + 1, 1, adj)[N]) ? Math.min(
  dijkstra(N + 1, 1, adj)[v1] + dijkstra(N + 1, v1, adj)[v2] + dijkstra(N + 1, v2, adj)[N],
  dijkstra(N + 1, 1, adj)[v2] + dijkstra(N + 1, v2, adj)[v1] + dijkstra(N + 1, v1, adj)[N]
) : -1;
}
